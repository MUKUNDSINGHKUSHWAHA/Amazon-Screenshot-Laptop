...
class AmazonScreenshotBot:
    ...
    def setup_ui(self):
        ...
        self.root.title("Amazon Screenshot Bot")
        ...
        tk.Label(
            footer_frame,
            text="Amazon Screenshot Bot | For automated mobile screenshots",
            bg=self.FOOTER_BG,
            fg=self.STATUS_FG,
            font=(self.FONT_FAMILY, 8)
        ).pack()
